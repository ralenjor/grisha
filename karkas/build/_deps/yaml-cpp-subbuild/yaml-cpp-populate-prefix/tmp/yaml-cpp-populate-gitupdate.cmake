...
execute_process(
  COMMAND "/usr/bin/git" --git-dir=.git show-ref "0.8.0"
  WORKING_DIRECTORY "/home/chris/Documents/Projects/grisha/karkas/build/_deps/yaml-cpp-src"
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: '/home/chris/Documents/Projects/grisha/karkas/build/_deps/yaml-cpp-src'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: '/home/chris/Documents/Projects/grisha/karkas/build/_deps/yaml-cpp-src'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
